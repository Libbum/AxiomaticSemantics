...
<ul class="pub-list">
    ...
    <li class="pub-item">
        <div class="pub-block">
            ...
            <span class="pub-links">[<button id="honoursa" class="abstractlink">Abstract</button>, <span id="honoursp" class="abstractlink">PDF</span>]</span>
        </div>
    ...
    <li class="pub-item">
        <div class="pub-block">
            ...
            <span class="pub-links">[<button id="undergrada" class="abstractlink">Abstract</button>, <span id="undergradp" class="abstractlink">PDF</span>]</span>
        </div>
